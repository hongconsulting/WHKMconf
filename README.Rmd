...
This package re-implements selected pointwise confidence intervals and simultaneous confidence bands for Kaplan–Meier survival estimates from the the `km.ci` package and from the work of [Sachs, Brand, and Gabriel (2022)](https://doi.org/10.1038/s41416-022-01920-5) for improved performance. Differences compared to `km.ci` include:
...
```{r, fig.width = 6, fig.height = 5, dpi = 150}
library(survival)
library(WHKMconf)
