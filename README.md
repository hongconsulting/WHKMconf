...
Gabriel](https://doi.org/10.1038/s41416-022-01920-5). The implementation
for Nair confidence bands allows arbitrary confidence levels rather than
being restricted to pre-computed tables of $e_\alpha$ critical values.
The implementation for Thomas–Grunkemeier confidence intervals maintains
numerical stability at extremely small $\alpha$ values that may arise
during the construction of Hollander–McKeague confidence bands. ‘WH’
