...
#' @export
WH_KMconf_med <- function(input) {
    .Call(`_WHKMconf_WH_KMconf_med`, input)
}
...
#' 31(8), pp. 557–560.
#' @export
WH_Rothman <- function(time, surv, risk, event, alpha = 0.05) {
    .Call(`_WHKMconf_WH_Rothman`, time, surv, risk, event, alpha)
}
